...
![frame]({{site.baseurl}}/images/mirror/frame.jpg)
...
![back]({{site.baseurl}}/images/mirror/back.jpg)
...
![staining]({{site.baseurl}}/images/mirror/staining.jpg)
...
![installing]({{site.baseurl}}/images/mirror/installing.jpg)

## Install

Finally, I glued the mirror to the front of the frame and hung it on the wall:

![final]({{site.baseurl}}/images/mirror/final.jpg)
